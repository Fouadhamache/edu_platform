...
const TeacherLayout: React.FC = () => {
  ...
  const sidebarItems = [
    { id: 'dashboard', label: 'لوحة التحكم', icon: Home, path: '/teacher/dashboard' },
    { id: 'create-lesson', label: 'إنشاء درس', icon: Plus, path: '/teacher/create-lesson' },
    { id: 'lessons', label: 'إدارة الدروس', icon: BookOpen, path: '/teacher/lessons' },
    { id: 'analytics', label: 'الإحصائيات', icon: BarChart3, path: '/teacher/analytics' },
  ];
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 overflow-hidden">
      ...
      <div className="hidden xl:flex xl:flex-col xl:w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 shadow-luxury">
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center">
            <div className="w-12 h-12 bg-blue-600 dark:bg-blue-500 rounded-xl flex items-center justify-center mr-3">
              <GraduationCap className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-xl font-bold text-gray-900 dark:text-white">منصة المعلمين</h1>
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">{currentTeacher?.specialization}</p>
            </div>
          </div>
        </div>
      ...
      <div className="xl:hidden fixed top-0 left-0 right-0 bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-700/50 p-4 flex items-center justify-between z-50">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900 dark:text-white">منصة المعلمين</h1>
          </div>
        </div>
          ...
          >
            <div className="p-4">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white">{currentTeacher?.name}</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-300">{currentTeacher?.specialization}</p>
                </div>
              </div>
