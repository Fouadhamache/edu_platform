...
const LandingPage: React.FC = () => {
  ...
  const features = [
    {
      ...
      color: 'from-gray-700 to-gray-900',
      bgColor: 'bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-900/50'
    },
    {
  ...
  return (
    <div className="bg-gradient-to-b from-white via-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-900 dark:to-black overflow-hidden">
      {/* Hero Section */}
      <section className="relative py-16 lg:py-24 xl:py-32">
        {/* Decorative Elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 right-10 w-32 h-32 bg-gradient-to-br from-gray-400/20 to-gray-600/20 rounded-full blur-xl"></div>
          <div className="absolute bottom-20 left-10 w-40 h-40 bg-gradient-to-br from-gray-500/20 to-gray-700/20 rounded-full blur-xl"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-gray-300/10 to-gray-500/10 rounded-full blur-3xl"></div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center">
            ...
            >
              <motion.div
                ...
                className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded-full text-gray-700 dark:text-gray-300 text-sm font-medium mb-6"
              >
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 sm:space-x-reverse justify-center lg:justify-start">
                <motion.button 
                  ...
                  className="group relative px-8 py-4 bg-gradient-to-r from-gray-900 to-black text-white rounded-2xl font-semibold text-lg shadow-2xl hover:shadow-gray-900/50 transition-all duration-300 overflow-hidden"
                ...
                {!isAuthenticated && (
                  <motion.button 
                    ...
                    className="px-8 py-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white border-2 border-gray-200 dark:border-gray-600 rounded-2xl font-semibold text-lg hover:border-gray-400 dark:hover:border-gray-500 hover:shadow-xl transition-all duration-300"
                    whileHover={{ scale: 1.05, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    تسجيل الدخول
              ...
              >
                <div className="flex items-center">
                  <Star className="w-4 h-4 text-gray-600 dark:text-gray-400 ml-1" />
                  <span>تقييم 4.9/5</span>
                </div>
                <div className="flex items-center">
                  <Users className="w-4 h-4 text-gray-600 dark:text-gray-400 ml-1" />
                  <span>+10,000 طالب</span>
                </div>
                <div className="flex items-center">
                  <Trophy className="w-4 h-4 text-gray-600 dark:text-gray-400 ml-1" />
                ...
                >
                  <div className="flex items-center space-x-3 space-x-reverse">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-gray-900 dark:text-white">AI مدعوم</p>
                    </div>
                  </div>
                </motion.div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 dark:text-white mb-6">
              ميزاتنا <span className="bg-gradient-to-r from-gray-700 to-black bg-clip-text text-transparent">التفاعلية</span>
            </h2>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            className="text-center mb-16"
            initial="hidden"
          ...
          >
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 dark:text-white mb-6">
              المراحل <span className="bg-gradient-to-r from-gray-700 to-black bg-clip-text text-transparent">التعليمية</span>
            </h2>
            <p className="text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                ...
                <div className="space-y-2">
                  ...
                  {level.years.map((year, yearIndex) => (
                    <div key={yearIndex} className="flex items-center text-sm text-gray-600 dark:text-gray-300">
                      <div className="w-2 h-2 bg-gradient-to-r from-gray-600 to-gray-900 rounded-full ml-2"></div>
                      {year}
                    </div>
                  ))}
      ...
      <section className="py-16 lg:py-24 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 dark:text-white mb-6">
              كيف <span className="bg-gradient-to-r from-gray-700 to-black bg-clip-text text-transparent">تعمل؟</span>
            </h2>
            <p className="text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ...
              >
                <div className="relative">
                  ...
                  {index < steps.length - 1 && (
                    <div className="hidden lg:block absolute top-8 left-full w-full h-0.5 bg-gradient-to-r from-gray-300 to-gray-500 dark:from-gray-600 dark:to-gray-800 z-0"></div>
                  )}
                  ...
                  <div className="relative z-10 bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all duration-500">
                    ...
                    <div className="absolute -top-4 right-4 w-8 h-8 bg-gradient-to-br from-gray-700 to-gray-900 text-white rounded-full flex items-center justify-center font-bold text-lg shadow-lg">
                      {step.number}
                    </div>
      ...
      {/* Pricing Section */}
      <section className="py-16 lg:py-24 bg-gradient-to-br from-white via-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            className="text-center mb-16"
            initial="hidden"
          ...
          >
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 dark:text-white mb-6">
              خطط <span className="bg-gradient-to-r from-gray-700 to-black bg-clip-text text-transparent">الاشتراك</span>
            </h2>
            <p className="text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          ...
          >
            ...
            <motion.div 
              ...
              whileHover={{ y: -8, scale: 1.02 }}
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-gray-400/20 to-gray-600/20 rounded-full blur-2xl"></div>
              ...
              <div className="relative z-10">
                ...
                <button 
                  onClick={handleMainAction} 
                  className="w-full py-4 bg-gradient-to-r from-gray-900 to-black text-white rounded-2xl font-semibold text-lg hover:from-gray-800 hover:to-gray-900 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  {getMainButtonText()}
                </button>
              </div>
            ...
            {/* Yearly Plan */}
            <motion.div 
              className="bg-gradient-to-br from-gray-900 to-black rounded-3xl p-8 shadow-2xl text-white relative overflow-hidden group"
              variants={fadeIn}
              whileHover={{ y: -8, scale: 1.02 }}
            >
              ...
              <div className="relative z-10">
                ...
                <div className="mb-8">
                  ...
                  <div className="mt-3 inline-flex items-center px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-sm">
                    <span className="text-gray-300 font-semibold ml-2">وفر 500 دج</span>
                ...
                <ul className="space-y-4 mb-8">
                  {[
                    ...
                    <li key={index} className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-gray-300 ml-3 flex-shrink-0" />
                      {feature}
                    </li>
                  ))}
                </ul>
                ...
                <button 
                  onClick={handleMainAction} 
                  className="w-full py-4 bg-white text-gray-900 rounded-2xl font-semibold text-lg hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  {getMainButtonText()}
                </button>
              </div>
      ...
      {/* CTA Section */}
      <section className="py-16 lg:py-24 bg-gradient-to-r from-gray-900 via-black to-gray-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 sm:space-x-reverse justify-center items-center">
              <motion.button 
                onClick={handleMainAction} 
                className="px-8 py-4 bg-white text-gray-900 rounded-2xl font-semibold text-lg hover:bg-gray-50 transition-all duration-300 shadow-xl hover:shadow-2xl"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
